...
from mailing.views import (
    Contacts, MailingAttemptCreateView,
...
urlpatterns = [
    ...
    path("contacts/", cache_page(60)(Contacts.as_view()), name="contacts"),    # noqa
    path("message/", MessageListView.as_view(), name="message"),         # noqa
    path("mailing/", MailingListView.as_view(), name="mailing_list"),   # noqa
    path("mailing/<int:pk>/run_mail/", run_mail, name="run_mail"),     # noqa
    path(
        "mailing/<int:pk>/detail/", MailingDetailView.as_view(), name="mailing_detail"    # noqa
    ),
    path(
        "message/<int:pk>/detail/", MessageDetailView.as_view(), name="message_detail"    # noqa
    ),
    path(
        "message/<int:pk>/delete/", MessageDeleteView.as_view(), name="message_delete"     # noqa
    ),
    path("message/<int:pk>/edit/", MessageUpdateView.as_view(), name="message_update"),     # noqa
    path("mailing/new/", MailingCreateView.as_view(), name="mailing_create"),      # noqa
    path("message/new/", MessageCreateView.as_view(), name="message_create"),     # noqa
    path("mailing/<int:pk>/edit/", MailingUpdateView.as_view(), name="mailing_update"),     # noqa
    path(
        "mailing/<int:pk>/delete/", MailingDeleteView.as_view(), name="mailing_delete"     # noqa
    ),
    path("receivemail/", ReceiveMailListView.as_view(), name="receivemail_list"),      # noqa
    path(
    ...
    path(
        "receivemail/create/", ReceiveMailCreateView.as_view(), name="receivemail_form"     # noqa
    ),
    path(
    ...
    path("send/create/", MailingAttemptCreateView.as_view(), name="send_create"),      # noqa
